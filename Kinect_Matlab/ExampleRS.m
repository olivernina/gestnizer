%- ExampleRS : Will show the difference between the IR reference and measurement,
%Depth of a ROI is equal to movement of the ROI between reference and measurement. 
%This depth can be calculated using a horizontal "tilt and scaling" invariant 
%normalized cross correlation (included version is not invariant).
